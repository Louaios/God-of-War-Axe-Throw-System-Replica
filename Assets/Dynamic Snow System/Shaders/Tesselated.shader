...
/// Final Color:
        ...
        Pass {
            ...
            float4 frag(VertexOutput i) : SV_Target {
                ...
                float4 _MainTex_var = tex2D(_MainTex,TRANSFORM_TEX(i.uv0, _MainTex));
                float4 _GroundMap_var = tex2D(_GroundMap,TRANSFORM_TEX(i.uv0, _GroundMap));
                float3 diffColor = lerp(_LowerLayer.rgb,(_MainTex_var.rgb*_BaseColor.rgb),_GroundMap_var.rgb);
                float4 _SpecMap_var = tex2D(_SpecMap,TRANSFORM_TEX(i.uv0, _SpecMap));
    ...
    FallBack "Dynamic Ground System/No Tesselation/Basic"
